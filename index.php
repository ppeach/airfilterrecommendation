...
<body class="bg-light">
    ...
    <main>
		...
		<div>
			<p>This tool helps recommend how many of the available models of portable air filters at different fan speeds will be required to meet current recommendations to reduce the risk of transmission of respiratory viruses like SARS-CoV-2. This is a non-profit public service that receives no commission for sales of any goods or services mentioned on this site</p> 
			<p>At the moment this database attempt to only includes air filters that use HEPA 13 filters and excludes any that have additional electronic cleaning features like ionisation and plasma that have insufficient evidence behind their efficacy and may result in production of undesirable pollutants. Devices with ionisation may be included if the function can be turned off, but CADR performance with ionisation off may not reflect that report by the manufacturers. If reliable data on the clean air delivery rate for small particles (CADR Smoke) is available, these will considered for inclusion</p>
