...
<head>
    ...
    <title>HEPA (Air) Filter Recommendation Tool</title>
...
<body class="bg-light">
    ...
    <main>
        ...
        <h2>HEPA (Air) Filter Recommendation tool</h2>
        </div>
		<div>
			<p>This tool helps recommend how many of the available models of HEPA (Air) filters at different fan speeds will be required to meet current recommendations to reduce the risk of transmission of respiratory viruses like SARS-CoV-2</p> 
			<p>This database only includes air filters that use HEPA 13 filters and excludes any that have additional electronic cleaning features like ionisation and plasma that have insufficient evidence behind their efficacy and may result in production of undesirable pollutants</p>
        ...
        <div class="container mt-5 mb-5" id="result-page">
            ...
            <ul class="list-inline">
                ...
                <?php echo (isset($ach)) ? '<li class="list-inline-item">: '.$ach.'.</li>' : ''; ?>
                        ...
                        <div class="col-md-6 mt-1">
                            ...
                            <div class="d-flex flex-row">
                                <small class="text-muted">
                                    ...
                                    <?php } else { ?>
                                        <li class="list-group-item"><i><?php echo $ach_needs; ?> devices required for 20L/p/s</i></li>
